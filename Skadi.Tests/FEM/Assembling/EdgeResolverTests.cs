...
public class EdgeResolverTests
{
    ...
    [Ignore("""
        В векторном МКЭ была переделана локальная нумерация рёбер. 
        Тест нужно либо адаптировать тесты, либо создать новый QuadElementEdgeResolver со старой нумерацией
    """)]
    [TestCase(0, 0, 2, 3, 4)]
    [TestCase(2, 4, 7, 8, 9)]
