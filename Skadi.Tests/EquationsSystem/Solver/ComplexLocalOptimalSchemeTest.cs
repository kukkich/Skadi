...
[TestFixture]
[TestOf(typeof(ComplexLocalOptimalSchemeSolver))]
...
public class ComplexLocalOptimalSchemeTest
{
    ...
    public void DefaultSlaeLackSmoothingShouldBeCorrect()
    {
        ...
        ISLAESolver<ComplexMatrix> solver = new ComplexLocalOptimalSchemeSolver
        (
            _config,
            _smoothing,
            1
        ...
        var result = solver.Solve(equation).ToArray();
